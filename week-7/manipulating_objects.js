...
// The only test that took me quite some time was test number 8, and the main reason was because the instructions were poorly written. I tired different approaches until the test passed. And it worked because that was the correct syntax to make it work I guess.

//How difficult was it to add and delete properties outside of the object itself?

// It wasn't difficult. You write delete followed by the object and it's property that you want to delete.

//What did you learn about manipulating objects in this challenge?
//
//I learned that there are several different ways to manipulate objects and their properties or values, and this challenge solidified my knowledge on this subject.
//
//
